...
broken line";
    ...
    public void StringsAreReallyImmutable()
    {
      ...
      var strB = "World";
      strA += strB;
      Assert.Equal(originalString, originalString);
    ...
    public void ABetterWayToConcatenateLotsOfStrings()
    {
      ...
      //String.Format and StringBuilder will be more efficeint that concatenation. Prefer them.
    }
    ...
    public void YouCanGetASubstringFromAString()
    {
      ...
      Assert.Equal(str.Substring(19), str.Substring(19));
