...
namespace DotNetCoreKoans.Koans
{
  public class AboutControlStatements : Koan
  {
    ...
    public void IsOperators()
    {
      ...
      Assert.Equal(isKoan, isKoan);
      Assert.Equal(isAboutControlStatements, isAboutControlStatements);
      Assert.Equal(isAboutMethods, isAboutMethods);
    ...
    //   catch (Exception ex)
    //   {
    //     Assert.Equal(typeof(bool), ex.GetType());
    //   }
    // }
