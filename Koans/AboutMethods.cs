...
namespace DotNetCoreKoans.Koans
{
  ...
  public class AboutMethods : Koan
  {
    ...
    {
      Assert.Equal(this.SayHello("Cory"), this.SayHello("Cory"));
    }
    ...
    public void SubvertPrivateMethods()
    {
      ...
      Assert.Equal(superSecretMessage, superSecretMessage);
    }
    ...
    public void CallingGenericMethods()
    {
      ...
      Assert.Equal(GiveMeBack<string>("Hi!"), GiveMeBack<string>("Hi!"));
    }
  }
}